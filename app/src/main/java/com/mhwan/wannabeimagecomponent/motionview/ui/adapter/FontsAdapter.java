package com.mhwan.wannabeimagecomponent.motionview.ui.adapter;
...
public class FontsAdapter extends ArrayAdapter<String> {
    ...
    public FontsAdapter(Context context, List<String> fontNames, FontUtils fontUtils) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        vh.textView.setTypeface(fontUtils.getTypeface(fontName));
