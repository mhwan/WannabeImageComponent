package com.mhwan.wannabeimagecomponent.motionview.widget.entity;
...
public class TextEntity extends MotionEntity {
    ...
    private Bitmap createBitmap(@NonNull TextLayer textLayer, @Nullable Bitmap reuseBmp) {
        ...
        textPaint.setTypeface(fontUtils.getTypeface(textLayer.getFont().getTypeface()));
